...
if (isset($_POST['textarea_1'])) {
     ...
     */
    $arr_fields = array(
        "idea_textarea_1" => $_POST['textarea_1'],
        "idea_textarea_2" => $_POST['textarea_2'],
        "idea_textarea_3" => $_POST['textarea_3']
    );
            ...
            <div class="left_forms_holder posRel">
                <div id="header">
                    ...
                    <div id="menu_holder" class="paddingTop10px paddingLeft100px">
                        ...
                        <div class="menu_item menu_item_active">Casting</div>
                ...
                <div id="main" class="">
                    <form action="page_5.php" method="post" enctype="multipart/form-data" name="myForm" id="myForm" class="margin0">
                        <div class="paddingLeft10px paddingTop10px">
                            <div class="selection">
                                ¿Quien compone el elenco?
                                <br/>
                                <textarea name="textarea_1" id="textarea_1" class="textarea" maxlength="600"></textarea>
                            </div>
                            <div class="selection">
                                ¿Cuál es el rol de cada persona?
                                <br/>
