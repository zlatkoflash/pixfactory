<?php
	...
	if(isset($_POST['textarea_1']))
	{
		...
		*/
		$arr_fields = array(
								"casting_textarea_1" => $_POST['textarea_1'],
								"casting_textarea_2" => $_POST['textarea_2']
							);
    	...
    	<div class="left_forms_holder posRel">
        	<div id="header">
                ...
                <div id="menu_holder" class="paddingTop10px paddingLeft100px">
                	...
                	<div class="menu_item menu_item_active">Propuesta de Valor</div>
                	<div class="menu_item">Otros</div>
                    <div class="clearBoth"></div>
                </div>
            </div>
            <div id="main" class="">
            	<form action="page_6.php" method="post" enctype="multipart/form-data" name="myForm" id="myForm" class="margin0">
					<div class="paddingLeft10px paddingTop10px">
                    	<div class="selection">
                        	¿Qué te incentivo a desarrollar tu idea?
                            <br/>
                            <textarea name="textarea_1" id="textarea_1" class="textarea" maxlength="600"></textarea>
                        </div>
                        <div class="selection">
                        	¿Qué hace diferente tu programa a los demas ?
                            <br/>
                            <textarea name="textarea_2" id="textarea_2" class="textarea" maxlength="300"></textarea>
                        </div>
                        <div class="selection">
                        	Por que consideras interesante tu idea?
                            <br/>
